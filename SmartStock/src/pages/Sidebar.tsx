...
const Sidebar: React.FC = () => {
  ...
  const handleLogout = () => {
    authService.logout(); // Elimina el token del localStorage
  ...
  return (
    <div className=" ">
      <div className="bg-white fixed inset-y-12 left-0 w-72 h-full px-4 py-8 flex flex-col justify-between shadow font-Judson rounded-r-2xl">
        ...
        className="text-blue-900 font-semibold text-center py-6 text-[30px] hover:text-[#488ED3] hover:scale-105 hover:underline transition-all duration-300"
      >
        Sign out
      </button>
    </div>
